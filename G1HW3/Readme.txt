...
20203043 권수현 - server.py 스레드 알고리즘 작성, log 작성, 스레드 관리, 디버깅

20203058 남태인 - 오류 해결, read me 작성, 코드 작성
...
◆ client.py 구성요소
① 큐
- failed_queue: 서버에서 특정 순번의 데이터 누락으로 인해 재전송 요청을 받은 경우 해당 순번을 여기에 저장하여 우선적으로 재전송을 준비
